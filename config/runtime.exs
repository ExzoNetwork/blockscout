...
config :block_scout_web, :footer,
  ...
  chat_link: System.get_env("FOOTER_CHAT_LINK", "https://discord.gg/FcU5y8hZ3m"),
  github_link: System.get_env("FOOTER_GITHUB_LINK", "https://github.com/ExzoNetwork"),
  forum_link_enabled: ConfigHelper.parse_bool_env_var("FOOTER_FORUM_LINK_ENABLED"),
  forum_link: System.get_env("FOOTER_FORUM_LINK", "https://discord.gg/FcU5y8hZ3m"),
